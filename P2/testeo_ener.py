...
if punto_fijo:
    ...
    lib.calc_kinetic_energy_fx.argtypes = [ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_float)]
...
def probar_calculo_moles():
    ...
    for A_fx, W_fx, expected_fx in datos:
        if punto_fijo:
            ...
            lib.calc_kinetic_energy_fx(dato_A, dato_W, ctypes.byref(resultado), ctypes.byref(res_fl))
