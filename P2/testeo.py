...
if punto_fijo:
    ...
    lib.calc_moles_fx.argtypes = [ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_float)]
...
def probar_calculo_moles():
    ...
    for Vp_fx, Vt_fx, expected_fx in datos:
        if punto_fijo:
            ...
            lib.calc_moles_fx(dato_Vp, dato_Vt, ctypes.byref(resultado), ctypes.byref(res_fl))           
